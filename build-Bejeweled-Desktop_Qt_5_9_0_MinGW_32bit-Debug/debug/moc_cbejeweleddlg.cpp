...
#include "../../Bejeweled/cbejeweleddlg.h"
...
struct qt_meta_stringdata_CBejeweledDlg_t {
    QByteArrayData data[10];
    char stringdata0[205];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CBejeweledDlg_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(5, 85, 23), // "on_pushButton_5_clicked"
...
QT_MOC_LITERAL(9, 181, 23) // "on_pushButton_8_clicked"
    ...
    "CBejeweledDlg\0on_pushButton_3_clicked\0"
    "\0on_pushButton_4_clicked\0on_pushButton_clicked\0"
...
static const uint qt_meta_data_CBejeweledDlg[] = {
...
const QMetaObject CBejeweledDlg::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_CBejeweledDlg.data,
      qt_meta_data_CBejeweledDlg,  qt_static_metacall, nullptr, nullptr}
};
...
void *CBejeweledDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CBejeweledDlg.stringdata0))
        return static_cast<void*>(const_cast< CBejeweledDlg*>(this));
